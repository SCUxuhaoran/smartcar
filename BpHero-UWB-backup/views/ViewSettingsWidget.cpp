    ...
    _floorplanOpen(false)
{
    ...
    connect(tcpSocket, &QTcpSocket::connected,
            [=]()
            {
                QString temp = QString("连接成功：[%1:%2]").arg(ui->TextIPAddress->text()).arg(ui->TextPortNumber->text());
                ui->TextStatus->setText(temp);
                ui->TextIPAddress->setEnabled(false);
                ui->TextPortNumber->setEnabled(false);
                ui->ButtonConnect->setText("断开连接");
    ...
    connect(tcpSocket, &QTcpSocket::disconnected,
            [=]()
            {
                ui->TextStatus->setText("无连接");
                ui->TextIPAddress->setEnabled(true);
                ui->TextPortNumber->setEnabled(true);
                ui->ButtonConnect->setText("连接小车");
                ui->ButtonConnect->setEnabled(true);
            }
            );
}
...
void ViewSettingsWidget::on_ButtonConnect_clicked()
{
    //获取ip地址和端口号
    QString ipAddress = ui->TextIPAddress->text();
    qint16 portNumber = ui->TextPortNumber->text().toInt();
    if(ui->ButtonConnect->text() == "断开连接")
    {
        //断开连接
        tcpSocket->disconnectFromHost();
        //ui->ButtonConnect->setEnabled(false);
    }
    else if(ui->ButtonConnect->text() == "连接小车")
    {
        //尝试连接
...
void ViewSettingsWidget::on_ButtonSpeedUp_clicked()
{
    //加速
    QByteArray arr = QByteArray("$0,0,0,1,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonSpeedDown_clicked()
{
    //减速
    QByteArray arr = QByteArray("$0,0,0,2,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonUp_pressed()
{
    //前进
    QByteArray arr = QByteArray("$1,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonUp_released()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonDown_pressed()
{
    //后退
    QByteArray arr = QByteArray("$2,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonDown_released()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
...
void ViewSettingsWidget::on_ButtonLeft_pressed()
{
    //左旋
    QByteArray arr = QByteArray("$0,1,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonLeft_released()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
...
void ViewSettingsWidget::on_ButtonRight_pressed()
{
    //右旋
    QByteArray arr = QByteArray("$0,2,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonRight_released()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
...
void ViewSettingsWidget::on_ButtonLeftForward_pressed()
{
    //左前
    QByteArray arr = QByteArray("$3,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonLeftForward_released()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
...
void ViewSettingsWidget::on_ButtonRightForward_pressed()
{
    //右前
    QByteArray arr = QByteArray("$4,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
}

void ViewSettingsWidget::on_ButtonRightForward_released()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
...
void ViewSettingsWidget::on_ButtonMiddle_clicked()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
...
void ViewSettingsWidget::on_ButtonMiddle_pressed()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
...
void ViewSettingsWidget::on_ButtonMiddle_released()
{
    //停止
    QByteArray arr = QByteArray("$0,0,0,0,0,0,0,0,0#");
    tcpSocket->write(arr);
